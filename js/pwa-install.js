/* Jatin Brand Studio — Custom "Install App" banner
   Shows a Lovish-Rental-Hub style install prompt when the browser
   fires beforeinstallprompt (Chrome/Edge/Android). */
(function () {
  var APP_NAME = 'Jatin Brand Studio';
  var APP_SUB  = 'Install Mobile App';
  var APP_ICON = '/assets/icons/icon-192.png';
  var DISMISS_KEY = 'jbs-install-dismissed';
  var DISMISS_DAYS = 7;
